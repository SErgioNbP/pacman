...
public class TerminalAppearance {
    ...
    public static final TerminalAppearance DEFAULT_APPEARANCE 
            = new TerminalAppearance(
                    DEFAULT_NORMAL_FONT,
                    DEFAULT_BOLD_FONT,
                    com.googlecode.lanterna.terminal.swing.TerminalPalette.DEFAULT,
                    true);
    ...
    private final com.googlecode.lanterna.terminal.swing.TerminalPalette colorPalette;
    private final boolean useBrightColorsOnBold;

    public TerminalAppearance(
            Font normalTextFont, 
            Font boldTextFont, 
            com.googlecode.lanterna.terminal.swing.TerminalPalette colorPalette,
    ...
    public com.googlecode.lanterna.terminal.swing.TerminalPalette getColorPalette() {
        return colorPalette;
    }
