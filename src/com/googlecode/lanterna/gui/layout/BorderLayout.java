...
public class BorderLayout implements LayoutManager {
    public static final com.googlecode.lanterna.gui.layout.LayoutParameter CENTER = new com.googlecode.lanterna.gui.layout.LayoutParameter("BorderLayout.CENTER");
    public static final com.googlecode.lanterna.gui.layout.LayoutParameter LEFT = new com.googlecode.lanterna.gui.layout.LayoutParameter("BorderLayout.LEFT");
    public static final com.googlecode.lanterna.gui.layout.LayoutParameter RIGHT = new com.googlecode.lanterna.gui.layout.LayoutParameter("BorderLayout.RIGHT");
    public static final com.googlecode.lanterna.gui.layout.LayoutParameter TOP = new com.googlecode.lanterna.gui.layout.LayoutParameter("BorderLayout.TOP");
    public static final com.googlecode.lanterna.gui.layout.LayoutParameter BOTTOM = new com.googlecode.lanterna.gui.layout.LayoutParameter("BorderLayout.BOTTOM");
    private static final Set<com.googlecode.lanterna.gui.layout.LayoutParameter> BORDER_LAYOUT_POSITIONS =
            Collections.unmodifiableSet(new HashSet<com.googlecode.lanterna.gui.layout.LayoutParameter>(Arrays.asList(
                CENTER,
                LEFT,
                RIGHT,
                TOP,
    ...
    private final Map<com.googlecode.lanterna.gui.layout.LayoutParameter, Component> components;

    public BorderLayout() {
        components = new IdentityHashMap<com.googlecode.lanterna.gui.layout.LayoutParameter, Component>(5);
    }

    @Override
    public void addComponent(Component component, com.googlecode.lanterna.gui.layout.LayoutParameter... parameters) {
        if(parameters.length == 0) {
            parameters = new com.googlecode.lanterna.gui.layout.LayoutParameter[] { CENTER };
        }
    ...
    @Override
    public List<? extends com.googlecode.lanterna.gui.layout.LayoutManager.LaidOutComponent> layout(TerminalSize layoutArea) {
        int availableHorizontalSpace = layoutArea.getColumns();
        int availableVerticalSpace = layoutArea.getRows();
        List<com.googlecode.lanterna.gui.layout.LayoutManager.LaidOutComponent> finalLayout = new ArrayList<com.googlecode.lanterna.gui.layout.LayoutManager.LaidOutComponent>();
        ...
        synchronized(components) {
            ...
            if(components.containsKey(TOP)) {
                ...
                finalLayout.add(
                        new com.googlecode.lanterna.gui.layout.DefaultLaidOutComponent(
                            topComponent, 
                            new TerminalSize(
