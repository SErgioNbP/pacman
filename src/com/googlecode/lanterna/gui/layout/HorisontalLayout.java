 ...
 * @author Martin
 */
public class HorisontalLayout extends com.googlecode.lanterna.gui.layout.LinearLayout {
    ...
    @Override
    protected com.googlecode.lanterna.gui.layout.LayoutParameter getMajorMaximizesParameter() {
        return com.googlecode.lanterna.gui.layout.LinearLayout.MAXIMIZES_HORIZONTALLY;
    }

    @Override
    protected com.googlecode.lanterna.gui.layout.LayoutParameter getMinorMaximizesParameter() {
        return com.googlecode.lanterna.gui.layout.LinearLayout.MAXIMIZES_VERTICALLY;
    }

    @Override
    protected com.googlecode.lanterna.gui.layout.LayoutParameter getMajorGrowingParameter() {
        return com.googlecode.lanterna.gui.layout.LinearLayout.GROWS_HORIZONTALLY;
    }
