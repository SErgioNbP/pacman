...
public class Table extends AbstractComponent implements InteractableContainer
{
    ...
    private final com.googlecode.lanterna.gui.component.Panel mainPanel;
    private final List<Component[]> rows;
    private com.googlecode.lanterna.gui.component.Panel[] columns;
    ...
    {
        if(title == null)
            mainPanel = new com.googlecode.lanterna.gui.component.Panel(com.googlecode.lanterna.gui.component.Panel.Orientation.HORISONTAL);
        else
            mainPanel = new com.googlecode.lanterna.gui.component.Panel(title, com.googlecode.lanterna.gui.component.Panel.Orientation.HORISONTAL);

        shortcutHelper = new ShortcutHelper();
        rows = new ArrayList<Component[]>();

        //Initialize to something to avoid null pointer exceptions
        columns = new com.googlecode.lanterna.gui.component.Panel[0];
    ...
    */
    ...
    public final void alterTableStructure(int nrOfColumns)
    {
        ...
        columns = new com.googlecode.lanterna.gui.component.Panel[nrOfColumns];
        for(int i = 0; i < nrOfColumns; i++) {
            columns[i] = new com.googlecode.lanterna.gui.component.Panel(Panel.Orientation.VERTICAL);
