...
public class ComboBox extends AbstractInteractableComponent {
    ...
    private com.googlecode.lanterna.gui.component.Label buttonLabel;
    ...
    private void Init(final GUIScreen screen, String emptyText, String title) {
        ...
        com.googlecode.lanterna.gui.component.Panel panel = new com.googlecode.lanterna.gui.component.Panel(Panel.Orientation.VERTICAL);
