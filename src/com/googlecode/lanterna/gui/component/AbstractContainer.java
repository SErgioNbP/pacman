 ...
 * @author Martin
 */
public abstract class AbstractContainer extends com.googlecode.lanterna.gui.component.AbstractComponent implements InteractableContainer, Container
{
    ...
    public void addComponent(Component component, LayoutParameter... layoutParameters)
    {
        ...
        if(component instanceof com.googlecode.lanterna.gui.component.AbstractComponent)
